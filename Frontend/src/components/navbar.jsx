            ...
            <nav className="bg-violet-800 h-16 p-3 mx-2 fixed top-2 flex justify-between items-center text-white rounded-3xl" style={{width:"90%"}}>
                ...
                <ul className="flex w-1/2 md:w-1/3 lg:w-1/5 justify-center items-center">
                    ...
                    <div className="dropdown cursor-pointer">
                        ...
                        <ul className="bg-blue-400 dropdown-content menu rounded-box z-[1] w-52 p-2 shadow ">
                            <li className="font-semibold cursor-pointer hover:text-slate-500">Hey</li>
                            <li className="font-semibold cursor-pointer hover:text-slate-500">Bye</li>   
                        </ul>
                    </div>
                </ul>
                <div className="flex items-center">
                <label className="cursor-pointer swap swap-rotate pr-2">
                ...
                <Link to='/' className='bg-white hover:bg-gray-400 text-black p-2 rounded-lg  font-bold' onClick={()=>{dispatch(userActions.login({token:'',info:null}))}} >LOGOUT</Link>
                </div>
            </nav>
        </>
    )
